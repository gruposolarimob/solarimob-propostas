...
const solutionLinks = [
  ...
  { label: "Calculadora solar", href: "/calculadora" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg text-white">
                Grupo <span className="text-amber-400">Solarimob</span>
              </span>
            </Link>
            <p className="text-sm leading-relaxed text-slate-400 mb-6">
              Especialistas em energia solar fotovoltaica. Transformamos
              irradiação solar em economia real para residências, empresas e
              propriedades rurais.
            </p>
            <div className="flex items-center gap-3">
              {COMPANY.instagram && (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-amber-400 flex items-center justify-center transition-colors group"
              ...
              {COMPANY.youtube && (
                <a
                  ...
                  aria-label="YouTube"
                >
                  <svg className="w-4 h-4 text-slate-400 group-hover:text-white fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
              )}
              {COMPANY.linkedin && (
                <a
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2.5 rounded-lg text-sm transition-colors w-full justify-center mb-3"
            >
            ...
            <a
              href={`mailto:${COMPANY.email}`}
              className="text-sm text-slate-400 hover:text-amber-400 transition-colors block text-center"
            >
              {COMPANY.email}
            </a>
          </div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-500">
            © {new Date().getFullYear()} Grupo Solarimob. Todos os direitos reservados.
          </p>
          <p className="text-xs text-slate-500">
